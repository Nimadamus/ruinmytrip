...
$pdo->exec('CREATE TABLE trips (id INTEGER PRIMARY KEY, user_id INT, destination_id INT, status TEXT)');
...
$ins = $pdo->prepare('INSERT INTO going (user_id,destination_id,date_from,date_to,visibility) VALUES (?,?,?,?,?)');
$ins->execute([1, 1, $soon, $later, 'public']);
$ins->execute([2, 1, $past, $past, 'public']);
$ins->execute([1, 2, $soon, $later, 'public']);
...
$pdo->exec("INSERT INTO trips (id,user_id,destination_id,status) VALUES (1,2,1,'published')");
