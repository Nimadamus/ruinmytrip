...
<div class="wrap">
  ...
  <p class="hint" style="margin:0 0 18px">
    "Ready" means five or more places across at least two kinds, coordinates on most of them, and
    at least five community reviews. It is a readiness check for building on, not a quality score,
    and nothing is published or hidden on the strength of it.
  </p>
  <div style="overflow-x:auto">
    <table style="width:100%;border-collapse:collapse;font-size:.92rem">
      <thead><tr style="text-align:left;border-bottom:1px solid #e9e9ee">
        ...
        <th style="padding:6px 8px">Reviews</th><th style="padding:6px 8px">Last review</th>
