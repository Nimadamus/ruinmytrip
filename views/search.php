<?php /** @var string $qs @var array $dests @var array $trips @var array $guides @var array $reviews @var array $people @var array $posts */ ?>
<div class="wrap" style="min-height:50vh">
  ...
  <?php if ($qs===''): ?><p class="muted">Type a place, a trip, a review, or a traveler to begin.</p><?php else: ?>
    <?php if (!$dests && !$trips && !$reviews && !$guides && !$posts && !$people): ?><p class="muted">No results for “<?= e($qs) ?>”.</p><?php endif; ?>
