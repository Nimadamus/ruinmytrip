...
ALTER TABLE activity_joins ADD COLUMN decided_at TEXT;
ALTER TABLE activity_joins ADD COLUMN decided_by INTEGER;

ALTER TABLE trip_activities ADD COLUMN capacity INTEGER;
ALTER TABLE trip_activities ADD COLUMN meeting_point TEXT;
ALTER TABLE trip_activities ADD COLUMN end_time TEXT;
ALTER TABLE trip_activities ADD COLUMN cancelled_at TEXT;
