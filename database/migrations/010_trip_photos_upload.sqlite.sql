...
ALTER TABLE trip_photos ADD COLUMN storage_key TEXT;
ALTER TABLE trip_photos ADD COLUMN width INTEGER;
ALTER TABLE trip_photos ADD COLUMN height INTEGER;
ALTER TABLE trip_photos ADD COLUMN bytes INTEGER;
ALTER TABLE trip_photos ADD COLUMN created_at TEXT;
