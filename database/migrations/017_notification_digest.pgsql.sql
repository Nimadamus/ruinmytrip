...
ALTER TABLE profiles ADD COLUMN IF NOT EXISTS last_digest_at TEXT;
ALTER TABLE profiles ADD COLUMN IF NOT EXISTS digest_opt_out INTEGER NOT NULL DEFAULT 0;
