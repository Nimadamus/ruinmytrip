-- RuinMyTrip schema (PostgreSQL / Render production). Idempotent.
...
CREATE TABLE IF NOT EXISTS profiles (
  ...
  display_name TEXT, bio TEXT, home_city TEXT,
  avatar_url TEXT, cover_url TEXT,
  credibility_score INTEGER NOT NULL DEFAULT 0, links_json TEXT
);
CREATE TABLE IF NOT EXISTS destinations (
  id SERIAL PRIMARY KEY,
  slug TEXT UNIQUE NOT NULL, name TEXT NOT NULL, country TEXT, region TEXT,
  lat DOUBLE PRECISION, lng DOUBLE PRECISION, summary TEXT, hero_url TEXT, category TEXT
);
CREATE TABLE IF NOT EXISTS trips (
  id SERIAL PRIMARY KEY,
  user_id INTEGER NOT NULL REFERENCES users(id) ON DELETE CASCADE,
  destination_id INTEGER REFERENCES destinations(id) ON DELETE SET NULL,
  title TEXT NOT NULL, slug TEXT NOT NULL, body TEXT, cover_url TEXT,
  visited_on TEXT, verified INTEGER NOT NULL DEFAULT 0,
...
CREATE TABLE IF NOT EXISTS reviews (
  ...
  user_id INTEGER NOT NULL REFERENCES users(id) ON DELETE CASCADE,
  destination_id INTEGER REFERENCES destinations(id) ON DELETE SET NULL,
  subject_type TEXT NOT NULL DEFAULT 'destination', subject_name TEXT,
  rating INTEGER NOT NULL, title TEXT, body TEXT, visited_on TEXT,
...
CREATE TABLE IF NOT EXISTS guides (
  ...
  premium INTEGER NOT NULL DEFAULT 0, status TEXT NOT NULL DEFAULT 'published', created_at TEXT NOT NULL
);
...
CREATE TABLE IF NOT EXISTS meetups (
  ...
  destination_id INTEGER REFERENCES destinations(id) ON DELETE SET NULL,
  title TEXT NOT NULL, description TEXT, date_start TEXT, date_end TEXT,
  visibility TEXT NOT NULL DEFAULT 'public', capacity INTEGER DEFAULT 0,
  safety_ack INTEGER NOT NULL DEFAULT 0, status TEXT NOT NULL DEFAULT 'published', created_at TEXT NOT NULL
);
...
CREATE TABLE IF NOT EXISTS notifications (
  id SERIAL PRIMARY KEY,
  user_id INTEGER NOT NULL REFERENCES users(id) ON DELETE CASCADE,
  type TEXT NOT NULL, actor_id INTEGER, target_type TEXT, target_id INTEGER,
  read_at TEXT, created_at TEXT NOT NULL
);
CREATE TABLE IF NOT EXISTS reports (
  id SERIAL PRIMARY KEY,
  reporter_id INTEGER NOT NULL REFERENCES users(id) ON DELETE CASCADE,
  target_type TEXT NOT NULL, target_id INTEGER NOT NULL, reason TEXT NOT NULL, details TEXT,
  status TEXT NOT NULL DEFAULT 'open', resolved_by INTEGER, created_at TEXT NOT NULL
);
